...
/***/ (function(module, exports, __webpack_require__) {
	...
	var beerEvents = __webpack_require__(8);
	var authEvents = __webpack_require__(34
...
/***/ (function(module, exports) {
	...
	var config = {
	  apiOrigins: {
	    production: 'https://shrouded-waters-11972.herokuapp.com'
	  }
	};
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var beerApi = __webpack_require__(9);
	var beerUi = __webpack_require__(11);
	var store = __webpack_require__(10);
	var getFormFields = __webpack_require__(33);

	var getBeers = function getBeers() {
	  beerApi.index().then(beerUi.getBeersSuccess).catch(beerUi.getBeersFailure);
	};

	var showBeers = function showBeers() {
	  store.beers = [];
	  beerApi.mybeers().then(beerUi.showBeersSuccess).catch(beerUi.showBeersFailure);
	};

	var hideBeers = function hideBeers() {
	  $('#beer').hide();
	};

	var deleteBeer = function deleteBeer(event) {
	  event.preventDefault();
	  var data = event.target.id.split('-');
	  var beerId = data[2];
	  beerApi.destroy(beerId).then(beerUi.deleteBeerSuccess).then(showBeers).catch(beerUi.deleteBeerFailure);
	};

	var updateBeer = function updateBeer(event) {
	  event.preventDefault();
	  var data = event.target.id.split('-'
	  //  const beerId = data[2]
	  );var beerUp = store.beers[data[3]];
	...
	var patchBeer = function patchBeer(event) {
	  event.preventDefault();
	  var data = getFormFields(this);
	  beerApi.update(data).then(beerUi.updateBeerSuccess).then(showBeers).catch(beerUi.updateBeerFailure);
	};

	var addBeer = function addBeer(event) {
	  event.preventDefault();
	  var data = getFormFields(this);
	  beerApi.create(data).then(beerUi.newBeerSuccess).then(showBeers).catch(beerUi.newBeerFailure);
	};
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var getBeer = function getBeer(beerId) {
	  return $.ajax({
	...
	var create = function create(addBeer) {
	  return $.ajax({
	    url: config.apiOrigin + '/beers',
	    method: 'POST',
	    data: addBeer,
	...
	var update = function update(upBeer) {
	  return $.ajax({
	...
	var destroy = function destroy(beerId) {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var store = __webpack_require__(10);
	var showBeersTemplate = __webpack_require__(12);
	var showBrewersTemplate = __webpack_require__(32);

	var getBeersSuccess = function getBeersSuccess(data) {
	  store.beers = data.beers;
	  var showBeersHTML = showBeersTemplate({
	    beers: data.beers
	  });
	  $('#brewers').empty();
	  $('#beers').empty();
	...
	var getBeersFailure = function getBeersFailure() {
	  $('#getBeersSuccessFailure').modal('show');
	};

	var showBeersSuccess = function showBeersSuccess(data) {
	  store.beers = data.beers;
	  var showBrewersHTML = showBrewersTemplate({
	    brewers: data.beers
	  });
	  $('#beers').empty();
	  $('#brewers').empty();
	...
	var showBeersFailure = function showBeersFailure() {
	  $('#showBeersFailure').modal('show');
	};

	var newBeerSuccess = function newBeerSuccess(beer) {
	  store.beer = beer;
	  $('#addModal').modal('toggle');
	  $('.form-addBeer').trigger('reset');
	};

	var newBeerFailure = function newBeerFailure(beer) {
	  //  console.log('create bombed')
	};
	var updateBeerSuccess = function updateBeerSuccess(beer) {
	  store.beer = beer;
	...
	var updateBeerFailure = function updateBeerFailure(beer) {
	  //  console.log('create bombed')
	};
	var deleteBeerSuccess = function deleteBeerSuccess(beer) {
	  //  console.log('delete beer success ran data is ', beer)
	  //  console.log(store.beer)
	};

	var deleteBeerFailure = function deleteBeerFailure(beer) {
	...
	module.exports = {
	  ...
	  showBeersSuccess: showBeersSuccess,
	  showBeersFailure: showBeersFailure,
	  newBeerSuccess: newBeerSuccess,
	  newBeerFailure: newBeerFailure,
	  updateBeerSuccess: updateBeerSuccess,
	  updateBeerFailure: updateBeerFailure,
	  deleteBeerSuccess: deleteBeerSuccess,
	  deleteBeerFailure: deleteBeerFailure
	};
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)))
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
	  ...
	  return "  <tbody>\n    <tr>\n      <td>"
	    + alias1(container.lambda(((stack1 = blockParams[0][0]) != null ? stack1.beer : stack1), depth0))
	    + "</td>\n      <td>"
	    + alias1(((helper = (helper = helpers.brewery || (depth0 != null ? depth0.brewery : depth0)) != null ? helper : alias3),(typeof helper === alias4 ? helper.call(alias2,{"name":"brewery","hash":{},"data":data,"blockParams":blockParams}) : helper)))
	    + "</td>\n      <td>"
	    + alias1(((helper = (helper = helpers.style || (depth0 != null ? depth0.style : depth0)) != null ? helper : alias3),(typeof helper === alias4 ? helper.call(alias2,{"name":"style","hash":{},"data":data,"blockParams":blockParams}) : helper)))
	    + "</td>\n      <td>"
	    + alias1(((helper = (helper = helpers.description || (depth0 != null ? depth0.description : depth0)) != null ? helper : alias3),(typeof helper === alias4 ? helper.call(alias2,{"name":"description","hash":{},"data":data,"blockParams":blockParams}) : helper)))
	    + "</td>\n    </tr>\n  </tbody>\n";
	},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data,blockParams) {
	    var stack1;

	  return "<div class=\"beerList\">\n <table class=\"table table-bordered tablebeers\">\n  <thead>\n    <tr>\n      <th>Brew</th>\n      <th>Brewery</th>\n      <th>Style</th>\n      <th>Description</th>\n    </tr>\n  </thead>\n"
	    + ((stack1 = helpers.each.call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? depth0.beers : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "")
	    + "  </table>\n</div>\n";
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
	  ...
	  return "  <tbody>\n    <tr>\n      <td>"
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.beer : stack1), depth0))
	    + "</td>\n      <td>"
	    + alias2(((helper = (helper = helpers.brewery || (depth0 != null ? depth0.brewery : depth0)) != null ? helper : alias4),(typeof helper === alias5 ? helper.call(alias3,{"name":"brewery","hash":{},"data":data,"blockParams":blockParams}) : helper)))
	    + "</td>\n      <td>"
	    + alias2(((helper = (helper = helpers.style || (depth0 != null ? depth0.style : depth0)) != null ? helper : alias4),(typeof helper === alias5 ? helper.call(alias3,{"name":"style","hash":{},"data":data,"blockParams":blockParams}) : helper)))
	    + "</td>\n      <td>"
	    + alias2(((helper = (helper = helpers.description || (depth0 != null ? depth0.description : depth0)) != null ? helper : alias4),(typeof helper === alias5 ? helper.call(alias3,{"name":"description","hash":{},"data":data,"blockParams":blockParams}) : helper)))
	    + "</td>\n      <td><button type=\"button\" id=\"btn-update-"
	    + alias2(alias1((depth0 != null ? depth0.id : depth0), depth0))
	    + "-"
	    + alias2(alias1(blockParams[0][1], depth0))
	    + "\" class=\"btn btn-small btn-primary btn-submit-fix btn-update-beer\">Update</button>\n      <!--form class=\"form-delete-beer\" -->\n        <button type=\"button\" id=\"btn-delete-"
	    + alias2(alias1((depth0 != null ? depth0.id : depth0), depth0))
	    + "\" class=\"btn btn-small btn-primary btn-submit-fix btn-delete-beer\">Remove</button></td>\n      <!--/form-->\n     </tr>\n    </tbody>\n";
	},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data,blockParams) {
	    var stack1;

	  return "<div class=\"brewerList\">\n<h3>Welcome - what's brewing?</h3>\n<table class=\"table table-bordered\">\n  <thead>\n    <tr>\n      <th>Brew</th>\n      <th>Brewery</th>\n      <th>Style</th>\n      <th>Description</th>\n      <th>Actions</th>\n    </tr>\n  </thead>\n"
	    + ((stack1 = helpers.each.call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? depth0.brewers : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 2, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "")
	    + "  </table>\n</div>\n\n<button type=\"button\" id=\"add\" class=\"btn btn-small btn-primary btn-submit-fix\" data-toggle=\"modal\" data-target=\"#addModal\">Add a brew</button>\n";
	},"useData":true,"useBlockParams":true});
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var userApi = __webpack_require__(35);
	var userUi = __webpack_require__(36);
	var beerEvents = __webpack_require__(8);
	var getFormFields = __webpack_require__(33
	// const store = require('../store')
	  ...
	  var data = getFormFields(this);
	  event.preventDefault();
	  userApi.signIn(data).then(userUi.signInSuccess).then(beerEvents.showBeers).catch(userUi.signInFailure);
	};
	...
	var linkBrewer = function linkBrewer() {
